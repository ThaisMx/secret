...
export default function VerificacaoData() {
  return (
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 max-w-md mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="font-medium mb-2">Etapa 2 de 2: Qual é a sua data de nascimento?</p>
